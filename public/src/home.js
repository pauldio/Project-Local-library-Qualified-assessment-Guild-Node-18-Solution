...
//Create a function getBooksBorrowedCount to return the total amount of books currently borrowed
//Declare a variable called booksBorrowed that filter through the books array
//
function getBooksBorrowedCount(books) {
  let booksBorrowed = books.filter((book) => book.borrows.filter(
    (record) => record.returned === false).length > 0
  )
